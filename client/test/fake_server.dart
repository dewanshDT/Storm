...
class FakeServer {
  ...
  http.Client get client => MockClient((request) async {
        ...
        if (failWith != null) {
          final code = failWith!;
          return http.Response('{"error":"refused"}', code,
        ...
        if (id.endsWith('/move')) {
          ...
          final moved = note.copyWith(
              path: body['new_path'] as String, version: note.version + 1);
          notes[id] = moved;
        ...
        if (request.method == 'PUT') {
          ...
          final updated = note.copyWith(content: content, version: note.version + 1);
          notes[id] = updated;
