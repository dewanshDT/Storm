...
class _NoteEditorState extends ConsumerState<NoteEditor> {
  ...
  Widget build(BuildContext context) {
    ...
    _controller.theme =
        dark ? MarkdownTheme.dark(base) : MarkdownTheme.light(base);
...
class _Notice extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final fg = isConflict ? scheme.onErrorContainer : scheme.onSecondaryContainer;
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(isConflict ? Icons.merge_type : Icons.info_outline, size: 16, color: fg),
